...
// passing in the middleware "auth" to let it check the user's token request
router.get('/', auth, async (req, res) => {
    // now we will call our DB to get the info 
    // of the user associated with auth token
    try {
        // -password will select all of the user's info except the password
